/*
 AngularJS v1.6.11-build.25963+sha.841feb0
...
(function (u) {
    ...
    function L(a, b) {
        ...
        return function () {
            var d = arguments[0], c;
            c = "[" + (a ? a + ":" : "") + d + "] http://errors.angularjs.org/1.6.11-build.25963+sha.841feb0/" + (a ? a + "/" : "") + d;
            for (d = 1; d < arguments.length; d++) {
                c = c + (1 == d ? "?" : "&") + "p" + (d - 1) + "=";
                var e = encodeURIComponent, f;
                f = arguments[d];
                f = "function" == typeof f ? f.toString().replace(/ \{[\s\S]*$/,
                    "") : "undefined" == typeof f ? "undefined" : "string" != typeof f ? JSON.stringify(f) : f;
                c += e(f)
            }
            return new b(c)
        }
    ...
    function xa(a, b, d) {
        function c(a, b, c) {
            ...
            } else if (Oc(a)) for (f in a) b[f] = e(a[f], c); else if (a && "function" === typeof a.hasOwnProperty) for (f in a) a.hasOwnProperty(f) && (b[f] = e(a[f], c));
    ...
    function Ge(a) {
        ...
        }]).info({angularVersion: "1.6.11-build.25963+sha.841feb0"})
    }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", function (a, b, c, e, p, I, J, R, M) {
            ...
            function W(a, b, d, e, f, g, h, k, l) {
                ...
                for (var n = -Number.MAX_VALUE,
                    ...
                    J = r.name;
                    if (!v && (r.replace && (r.templateUrl || r.template) || r.transclude &&
                            !r.$$tlb)) {
            ...
            function fa(a, b, d, f, g, h, k, l) {
                var m = [], p, n, B = b[0], r = a.shift(),
                    w = $b(r, {templateUrl: null, transclude: null, replace: null, $$originalDirective: r}),
    ...
    function Hf() {
        var a = this.defaults = {
            ...
            headers: {common: {Accept: "application/json, text/plain, */*"}, post: ha(vc), put: ha(vc), patch: ha(vc)},
    ...
    function Gf() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function (a, b, d, c, e) {
            function f(f, h, l, m) {
                ...
                var n = 4 < arguments.length, t = n ? va.call(arguments, 4) : [], r = b.setInterval,
                    B = b.clearInterval, w = 0, V = v(m) && !m, K = (V ? c : d).defer(), q = K.promise;
                l = v(l) ? l : 0;
    ...
    function Pf() {
        ...
        this.$get = ["$filter", function (e) {
            ...
            function h(a, b, c, d, e) {
                ...
                var h = d.literal ? l : v, k, m, n = d.$$intercepted || d, r = d.$$interceptor || Qa,
                    t = d.inputs && !n.inputs;
                g.literal = d.literal;
            ...
            m.prototype = {
                constructor: m, $new: function (b, c) {
                    ...
                    do {
                        ...
                        if ((t || K.length) &&
                            !q--) throw s.$$phase = null, d("infdig", b, A);
                    } while (t || K.length);
    ...
    function Vf() {
        this.$get = ["$window", "$document", function (a, b) {
            var d = {},
                ...
                e = da((/android (\d+)/.exec(O((a.navigator ||
    ...
    var Nc = {objectMaxDepth: 5}, ah = /^\/(.+)\/([a-z]*)$/, ra = Object.prototype.hasOwnProperty, O = function (a) {
        ...
        }, Aa, y, sb, va = [].slice, xg = [].splice, bh = [].push, ia = Object.prototype.toString,
    ...
    var te = /^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array]$/,
        ...
        Be = /[A-Z]/g, Xc = !1, La = 3,
        He = {full: "1.6.11-build.25963+sha.841feb0", major: 1, minor: 6, dot: 11, codeName: "snapshot"};
    W.expando = "ng339";
    var Na = W.cache = {}, ig = 1;
    W._data = function (a) {
        return this.cache[a[this.expando]] || {}
    };
    var eg = /-([a-z])/g, ch = /^-ms-/, Bb = {mouseleave: "mouseout", mouseenter: "mouseover"}, lc = L("jqLite"),
        hg = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, kc = /<|&#?\w+;/, fg = /<([\w:-]+)/,
        gg = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ma = {
    ...
    var qd = /^((?:x|data)[:\-_])/i, wg = /[:\-_]+(.)/g, wd = L("$controller"), vd = /^(\S+)(\s+as\s+([\w$]+))?$/,
        Ef = function () {
            this.$get = ["$document",
                function (a) {
                    return function (b) {
        ...
        }, xd = "application/json", vc = {"Content-Type": xd + ";charset=utf-8"}, zg = /^\[|^\{(?!\{)/,
    ...
    var Dg = L("$interval"), Mf = function () {
        ...
        }, gh = /^([^?#]*)(\?([^#]*))?(#(.*))?$/, Eg = {http: 80, https: 443, ftp: 21}, jb = L("$location"),
        Fg = /^\s*[\\/]{2,}/, hh = {
    ...
    var oa = L("$sce"),
        ...
        Cc = /_([a-z])/g, Lg = L("$templateRequest"), Mg = L("$timeout"), T = u.document.createElement("a"),
        Pd = na(u.location.href), Ua;
    Qd.$inject = ["$document"];
    ed.$inject = ["$provide"];
    var Xd = 22, Wd = ".", Ec = "0";
    Rd.$inject = ["$locale"];
    ...
    var je = function (a) {
        ...
        Zg = /^\s*(-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, ke = /^(\d{4,})-(\d{2})-(\d{2})$/,
        le = /^(\d{4,})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Mc = /^(\d{4,})-W(\d\d)$/,
        me = /^(\d{4,})-(\d\d)$/,
    ...
    var pf = function () {
        ...
        }, af = Va({terminal: !0, priority: 1E3}), oh = L("ngOptions"),
                ...
                return {
                    trackBy: r, getTrackByValue: u, getWatchables: d(H, function (a) {
                        ...
                        for (var a = [], b = {}, d = H(c) || [], g = f(d), k = g.length, n = 0; n < k; n++) {
                            var p = d === g ? n : g[n], q = z(d[p], p), t = s(c, q), p = v(t, q), w = x(c, q),
                                y = A(c, q), q = E(c, q), t = new e(p, t,
                                w, y, q);
                            a.push(t);
                            b[p] = t
                        }
            ...
            return {
                link: function (f,
                    ...
                    var l = k.count, m = k.$attr.when && g.attr(k.$attr.when), p = k.offset || 0, n = f.$eval(m) || {},
                        t = {}, r = b.startSymbol(), s = b.endSymbol(), w = r + l + "-" + p + s, u = Z.noop, v;
                    q(k, function (a, b) {
                        var c = e.exec(b);
